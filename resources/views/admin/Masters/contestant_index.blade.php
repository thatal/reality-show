                    ...
                    <div class="tabbable">
                        ...
                        <div class="tab-content">
                            <div id="home4" class="tab-pane active">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        {!!Form::open(['url' => route('admin.contestant.save'), 'class' => "form-horizontal form-validator"])!!}
                                            <div class="form-group row {{ $errors->has('name') ? ' has-error' : '' }}">
                                                {!!Html::decode(Form::label('name', 'Name <span class="text-danger">*</span>', ['class' => 'control-label col-sm-3']))!!}
                                                <div class="col-sm-9">
                                                    {!!Form::text('name',null, ['class' => 'form-control', 'data-error' => 'Contestant name is required.','placeholder' => 'Contestant Name', 'required' => true])!!}
                                            ...
                                            <div class="form-group row {{ $errors->has('code') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-sm-9">
                                                    {!!Form::text('code',null, ['class' => 'form-control', 'data-error' => 'Code is required.','placeholder' => 'Contestant Code', 'required' => true])!!}
                                            ...
                                            <div class="form-group row {{ $errors->has('mobile') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-sm-9">
                                                    {!!Form::text('mobile',null, ['class' => 'form-control', 'placeholder' => 'Mobile number','maxlength' => '10', 'minlength' => '10', 'size' => 10])!!}
                                            ...
                                            <div class="form-group row {{ $errors->has('email') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-sm-9">
                                                    {!!Form::email('email',null, ['class' => 'form-control', 'data-error' => 'Email is required.','placeholder' => 'Email'])!!}
                                            ...
                                            <div class="form-group row {{ $errors->has('gender') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-sm-9">
                                                    {!!Form::select('gender',['male' =>'Male','female' =>'Female'],'--Select--',['class' => 'form-control', 'data-error' => 'Please Select a gender.'])!!}
                                            ...
                                            <div class="form-group row {{ $errors->has('age') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-sm-9">
                                                    {!!Form::number('age',null, ['class' => 'form-control', 'data-error' => 'age is required.','placeholder' => 'age'])!!}
                                            ...
                                            <div class="form-group row {{ $errors->has('facebook') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-sm-9">
                                                    {!!Form::url('facebook',null, ['class' => 'form-control', 'placeholder' => 'Facebook Link'])!!}
                                            ...
                                            <div class="form-group row {{ $errors->has('instagram') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-sm-9">
                                                    {!!Form::url('instagram',null, ['class' => 'form-control', 'placeholder' => 'Instagram Link'])!!}
                            ...
                            <div id="profile4" class="tab-pane">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-condensed table-hover data_table">
                                        <thead>
                                            <tr>
                                            {{-- 'code','`','mobile','email','facebook','instagram','status','gender','age' --}}
                                                <th>Sl. No.</th>
                                                <th>Name</th>
                                                <th>Code</th>
                                                <th>Mobile</th>
